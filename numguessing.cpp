...
int main()
{
    ...
    {   char hint;
        ++trials;
    cout<<"user please enter your guessed number between 1 to 100 \n";
    cin>>guess_num;
    ...
    {
        cout<<"do you wish to have a hint y or n\n";
        cin>>hint;
        if(hint=='y')
        {
            if(random_num>guess_num)
    ...
    cout<<"Do you wish to continue with the guessing y or n\n";
    cin>>choice;
    if(choice=='n')
    {   
